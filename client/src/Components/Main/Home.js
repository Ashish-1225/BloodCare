    ...
    return (
        <div className="dark:text-white-900">
            ...
            <div className='w-full bg-blood text-white-900 h-max text-sm text-center font-bold'>
                <code> BloodCare @ {new Date().getFullYear()} || Made with ❤️ by <a href="https://www.linkedin.com/in/ashish-kumar2512/" target="_blank">@Ashish</a> </code>
            </div>
        </div>
    )
}
