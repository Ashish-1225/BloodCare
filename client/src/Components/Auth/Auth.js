...
const Auth = (props) => {
    ...
    const signUp = async (e) => {
        e.preventDefault();
        try {
            console.log("Signing up with handle:", handle);
            var formData;
            if (handle === "bank") {
                formData = {
                    name: name,
            ...
            console.log("Sending request to:", `/auth/${handle}`);
            console.log("Request data:", formData);
            
            const response = await axios.post(`/auth/${handle}`, formData, { 
            ...
            if (err.response) {
                ...
                alert(err.response.data?.errorMessage || "An error occurred during sign up");
            } else if (err.request) {
